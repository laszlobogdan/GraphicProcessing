...
float translatePlaneY = 50.0f;
float translatePlaneZ = 10.0f;
...
void initObjects() {
	plane.LoadModel("objects/proj/14082_WWII_Plane_Japan_Kawasaki_Ki-61_v1_L2.obj");
	obj.LoadModel("objects/proj/LowPolyCars.obj");
...
void initUniforms() {
	...
	lightDir = glm::vec3(10.0f, 1.0f, 5.0f);
...
glm::mat4 computeLightSpaceTrMatrix() {
	...
	//glm::mat4 lightView = glm::lookAt(lightDir, glm::vec3(0.0f), glm::vec3(0.0f));
...
void drawObjects(gps::Shader shader, bool depthPass) {
	...
	model = glm::translate(model, glm::vec3(0.0f, 1.0f, 0.0f) * translatePlaneY);
	model = glm::translate(model, glm::vec3(0.0f, 0.0f, 1.0f) * translatePlaneZ);
...
void renderScene() {
	...
	if (showDepthMap) {
		...
		lightRotation = glm::rotate(glm::mat4(1.0f), glm::radians(lightAngle), glm::vec3(0.0f, 1.0f, 0.0f));
		lightDir = glm::vec3(lightRotation * glm::vec4(3.0f, 1.0f, 1.0f, 0.0f));
		glUniform3fv(lightDirLoc, 1, glm::value_ptr(glm::inverseTranspose(glm::mat3(view * lightRotation)) * lightDir));
